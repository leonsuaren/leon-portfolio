export const english = {
   ...
   projectsOverview: [
     ...
     {name: 'Real Time Bus Tracker', description: 'Interactive Map that shows some bus stops in L.A', languages: 'JavaScript, HTML, CSS'},
     {name: 'Movies', description: 'Find the movie you want with all the content you need', languages: 'Full Stack Project With MERN and Bootstrap'},
  ],
